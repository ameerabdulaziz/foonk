            ...
            foreach ($result as $product): ?>
                <div class="col-md-3">
                    <div class="col-md-12 item no-padding">
                        <div class="top">
                            <img class="img-responsive" src="<?=PRODUCTS.$product['prod_image']?>" alt="<?=$product['prod_title']?>">
                        </div>
                        <div class="bottom">
                            <h3 class="item-title pull-left"><?=$product['prod_title']?></h3>
                            <div class="pull-right price">$<?= $product['prod_price']; ?></div>
                            <div class="clearfix"></div>
                            <div style="color: #a4a11b" class="text-center">Rating: <?=round($product['rating'])?>/5</div>
